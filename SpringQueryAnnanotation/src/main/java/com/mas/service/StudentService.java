...
public class StudentService {
	...
	public List<StudentDetails>  findByNameOrderByAge() {
		List<StudentDetails> findByNameOrderByAge = studentRepository.findByNameOrderByAge();
		return findByNameOrderByAge;
		
	}
	
	  public List<StudentDetails> findByNameOrderByName() { List<StudentDetails>
	  findByNameOrderByName = studentRepository.findByNameOrderByName(); return
