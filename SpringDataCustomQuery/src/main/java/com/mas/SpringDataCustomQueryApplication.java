...
public class SpringDataCustomQueryApplication {

	public static void main(String[] args) {
		ConfigurableApplicationContext context = SpringApplication.run(SpringDataCustomQueryApplication.class, args);
...
//findByNameOrAge
	 ...
	 //or with name example
		 ...
		 */
		 ...
		 List<StudentDetails> findByNameOrderByName = studentService.findByNameOrderByName();
